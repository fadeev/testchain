...
export const protobufPackage = 'fadeev.testchain.testchain';
...
export class MsgClientImpl {
    ...
    CreatePost(request) {
        ...
        const promise = this.rpc.request('fadeev.testchain.testchain.Msg', 'CreatePost', data);
        return promise.then((data) => MsgCreatePostResponse.decode(new Reader(data)));
    }
    UpdatePost(request) {
        const data = MsgUpdatePost.encode(request).finish();
        const promise = this.rpc.request('fadeev.testchain.testchain.Msg', 'UpdatePost', data);
        return promise.then((data) => MsgUpdatePostResponse.decode(new Reader(data)));
    }
    DeletePost(request) {
        const data = MsgDeletePost.encode(request).finish();
        const promise = this.rpc.request('fadeev.testchain.testchain.Msg', 'DeletePost', data);
